...
public class CalculatorAnualFragment extends CalculatorBaseFragment {

    public CalculatorAnualFragment() {
        // Required empty public constructor
    }

    public static CalculatorAnualFragment newInstance() {
        CalculatorAnualFragment fragment = new CalculatorAnualFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_calculator_anual, container, false);
    ...
    private void calculaNotas(View view) {
        ...
        if (getNotasEditText() && verificaNotasReais(zeroAcem)) {
            NotasCalculadoraAnual notasCalculadoraAnual = new NotasCalculadoraAnual(zeroAcem, notaB1, notaB2, notaB3, notaB4, notaProvaFinal);
            if (!erroPesos) {
                resultadoCalculo = notasCalculadoraAnual.calculaNotas(confDisc);
